    ...
    return (
        <button
            ...
            className={cn(
                ...
                hasResonated
                    ...
                    : "bg-white text-black hover:bg-white/90 hover:scale-105 active:scale-95 shadow-[0_0_50px_rgba(255,255,255,0.2)]",
        ...
        >
            ...
            <div className="relative z-10 flex items-center gap-4">
                <Heart
                    fill={(hasResonated || isHovered) ? "currentColor" : "none"}
                    className={cn(
                        "w-5 h-5 transition-all duration-500",
                        (hasResonated || isHovered) ? "text-red-500 scale-110" : "text-black",
                        hasResonated && "animate-bounce"
                    )}
                />
                <span className={cn(
                    "text-[10px] font-black tracking-[0.2em] uppercase transition-colors",
                    hasResonated ? "text-red-400" : "text-black"
                )}>
                    {isLoading ? "Broadcasting..." : hasResonated ? "You resonated" : "I feel this too"}
                </span>
            </div>
            ...
            <div className={cn(
                ...
                hasResonated ? "bg-red-500/20 text-red-400" : "bg-black/10 text-black/60"
            )}>
